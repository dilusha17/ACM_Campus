...
<body>
<div class="wrap">
  <div class="header"><h1>New Admission Application</h1></div>
  <div class="body">
    ...
    @endif
    <p style="margin-top:24px"><a href="{{ url('/admin/admissions') }}" style="background:#1a3a5c;color:#fff;padding:10px 22px;border-radius:6px;text-decoration:none;font-size:14px">Review in Admin Panel</a></p>
  </div>
